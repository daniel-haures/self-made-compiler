...
public class Lexer3 {
    ...
    public Token lexical_scan(BufferedReader br) {
        ...
        switch (peek) {
            ...
            case '/':
                readch(br);
                /*Se il commento è su una sola riga è neccesario scartare tutti caratteri
                fino a trovare EOF o il carattere a capo*/
                if(peek=='/'){
                    do{
                        readch(br);
                    }while(peek!='\n' && peek!=(char)-1);
                    return lexical_scan(br);
                /*Se il commento è multiriga*/
                }else if(peek=='*'){
                    readch(br);
                    boolean flag=true;
                    /*Scarta gli elementi finchè non trova EOF oppure la fine del commento*/
                    ...
                    if(peek!=(char)-1){
                        /*Non è disponibile ancora nessun token, perciò è neccessario ritornare il token successivo*/
                        return lexical_scan(br);
                    }else{
                        /*Segnalo che il commento non è stato chiuso*/
